...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Notification System")
        self.setGeometry(100, 100, 600, 400)

        self.__button: QPushButton = QPushButton("Click", self)
        self.__button.setFixedWidth(100)
    ...
    def __update_main_widgets_position(self) -> None:
        ...
        self.__combo_box_duration.setGeometry(x + button_width + 10, y, combo_box_duration_width,
                                              combo_box_duration_height)
